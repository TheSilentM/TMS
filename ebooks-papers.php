...
<!--immagine di copertina-->
  <div class='container-fluid p-0'>
    <div class='row col-12 m-0 background-img'>
    <div class='col-lg-12 p-5 m-auto text-center'>
      <h1 class='fst-italic fw-bold'>Freight and Shipping Management</h1>
      <h4 class='lead my-3 pt-2'><strong class='mb-2 text-white'>Ebooks and Whitepapers</strong></h4>
    </div>
    </div>
  </div>
  <div class='col-lg-12'>
    <div class='col-lg-8 m-auto text-center p-5'>
      <p class='lead my-3 pb-5'><strong class='mb-2 text-white-emphasis'>Learn best practices for transportation management, logistics and supply chain operations by reading FreightPOPs free Ebooks and Whitepapers. Be sure to subscribe to be notified of new content!</strong></p>
  ...
  <div class='col-12'>
    <div class='col-8 m-auto text-center'>
      <h2 class='h2 fw-bold m-0 pb-3'>EBOOKS</h2>
    </div>
  </div>
    <div class='container marketing'>
      ...
      <?php 
        ...
        $query = "SELECT DISTINCT ebooks.ebook_title, ebooks.ebook_category FROM ebooks";
          ...
          while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
            echo "
                <div class='col-lg-4 col-md-6 col-sm-10 p-3'>
                  <div class='card'>
                    <img class='card-img-top' src='img/airfreight1.png' alt='Card image cap'>
                    <div class='card-body min-height'>
                      <h6 class='card-subtitle mb-2 text-success text-center fw-bold'>".$row['ebook_category']."</h6>
                      <h4 class='card-title pt-2 pb-3 text-center min-height-title'>".$row['ebook_title']."</h4>
                      <h6 class='h6 fw-bold'><a class='btn btn-outline-success d-grid w-75 m-auto' href='sea-freight.php'>View Ebook &raquo;</a></h6>
                    </div>
                  </div>
                </div>
            ";
        ...
        <?php 
        require_once('connection.php');
        $query = "SELECT DISTINCT whitepapers.whitepaper_category, whitepapers.whitepaper_title FROM whitepapers";
        $result = mysqli_query($connection, $query);
        if(mysqli_num_rows($result)!=0) {
          while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
            echo "
                <div class='col-lg-4 col-md-6 col-sm-10 p-3'>
                  <div class='card'>
                    <img class='card-img-top' src='img/roi-calculator-icon.png' alt='Card image cap'>
                    <div class='card-body min-height'>
                      <h6 class='card-subtitle mb-2 text-success text-center fw-bold'>".$row['whitepaper_category']."</h6>
                      <h4 class='card-title pt-2 pb-3 text-center min-height-title'>".$row['whitepaper_title']."</h4>
                      <h6 class='h6 fw-bold'><a class='btn btn-outline-success d-grid w-75 m-auto' href='sea-freight.php'>View Ebook &raquo;</a></h6>
                    </div>
                  </div>
                </div>
