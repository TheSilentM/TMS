...
<div class='container pt-5 mt-5'>
    ...
    <nav class='nav nav-underline justify-content-between'>
      ...
      <a class='nav-item nav-link link-body-emphasis active' href='freight.php'>Freight</a>
...
$query = "SELECT DISTINCT categories_blog.categories, categories_blog.categories_ID, blog_news.news_title, blog_news.reading_time, blog_news.text_preview FROM categories_blog, blog_news WHERE categories_blog.categories_ID = 'FR'";
