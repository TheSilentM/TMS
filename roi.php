...
<main>
 <div class="container-fluid mb-5">
      ...
      <div class="row m-auto justify-content-center my-4">
        <form class="col-lg-6 col-md-10 col-sm-10 text-center bg-light-subtle rounded shadow my-5" action="roi-added.php" method="POST">
            <h1 class="py-3">Calculate your ROI</h1>
            <div class="col-lg-6 col-md-8 col-sm-10 m-auto pb-5">
              <!--insert data for calculate ROI-->
              <label class="form-label" for="profit">What's your annual profit?</label>
              <div class="input-group mb-3">
                <span class="input-group-text">€</span>
                <input type="text" class="form-control" name="profit" aria-label="Your gross profit" placeholder="your gross profit..." required />
              </div>

              <label class="form-label" for="cost-investment">What's your initial costs?</label>
              <div class="input-group mb-3">
                <span class="input-group-text">€</span>
                <input type="text" class="form-control" name="cost-investment" aria-label="your initial costs of investment" placeholder="your initial costs of investment..." required />
              </div>

              <div class="pt-4 text-center">
                <button type="submit" value="Next" class="btn btn-success w-50">Next</button>
              </div>
            </div>
        </form>
      </div>
