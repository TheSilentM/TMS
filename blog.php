...
<div class='container pt-5 mt-5'>
  ...
  <div class='nav-scroller mb-3 border-bottom'>
    <nav class='nav nav-underline justify-content-between'>
      <a class='nav-item nav-link link-body-emphasis active' href='blog.php'>All</a>
      <a class='nav-item nav-link link-body-emphasis' href='freight.php'>Freight</a>
      <a class='nav-item nav-link link-body-emphasis' href='customer-news.php'>Customer Spotlight</a>
      <a class='nav-item nav-link link-body-emphasis' href='logistics-news.php'>Logistics</a>
    </nav>
  </div>
</div>

<main class='container'>
  <div class='p-4 p-md-5 mb-4 pb-5 rounded text-body-emphasis background-img'>
    <div class='col-lg-6 px-0 position-relative'>
      <h1 class='h1 fst-italic pt-4'>Optimizing Less Than Truckload (LTL) Shipping with TMS Software</h1>
      <strong class='d-inline-block mb-2 text-success fw-bold'>Freight</strong>
      ...
      <p class='lead mb-3'><a href='#' class='text-body-emphasis text-decoration-none fw-medium me-2'>Continue reading</a><i class='bi bi-arrow-right pb-4'></i></p>
    </div>
  </div>
<!--1° grid-->
<div class='row mb-2'>
...
$query = "SELECT DISTINCT categories_blog.categories, blog_news.news_title, blog_news.reading_time, blog_news.text_preview FROM blog_news LEFT JOIN categories_blog ON categories_blog.categories_ID = blog_news.categories_ID";
...
<hr class="col-10 m-auto mb-5 border-3 pt-4">

<!--FOOTER-->
  <div class='container'>
    <footer class='row text-center text-lg-start text-white justify-content-center py-5 pt-1'>
      <div class='col mb-3'>
        <a href='#' class='d-flex align-items-center mb-3 link-body-emphasis text-decoration-none justify-content-center'>
          <h4>TMS</h4>
        </a>
