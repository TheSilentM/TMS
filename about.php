 ...
 <div class="container-fluid">
      <div class="row bg-light-subtle z-1 p-5">
        <div class="container-text text-center">
            <h1 class="h1 p-3 fw-bold">About Us</h1>
            <h4 class="h4 fw-bold pb-5">Our Commitment to you and to each other</h4>
        </div>
      </div>
      <div class="col-lg-6 col-md-10 col-sm-8 m-auto my-5 text-center">
        <h2 class="h2 fw-bold text-success">Our Mission</h2>
        <h6 class="h6 fw-bold py-3">We simplify and streamline the transportation management experience for manufacturers, distributors 
            by reducing friction and connecting systems for a seamless and optimal supply chain.
        </h6>
      </div>
      <div class="col-lg-6 col-md-10 col-sm-8 m-auto my-5 text-center">
        <h2 class="h2 fw-bold text-success pt-5">Our Story</h2>
        <p class="paragraph m-0 pt-4">The idea of TMS transportation management system was born out of frustration with our own shipping problems at Horizon Technology, 
            a technology distribution company that has been in business for more than 20 years. 
            From using an outdated method of spreadsheets to manage shipping, 
            and then switching to an enterprise TMS that didn’t work, there was no solution in the market to address the needs of the growing company.
        </p>
        <br>
        <p class="paragraph m-0">Horizon was tired of wasting time and money, 
            and wanted to fix this problem by creating a better way to handle shipping and logistics for those that are also frustrated with clunky, legacy enterprise TMS.
            Being a company who handles all their own shipping, 
            Horizon understood the problems companies like them were facing and knew they could create a TMS that not only solved these issues but was easy to use.
        </p>
        <br>
        <p class="paragraph m-0 pb-5">
        With a spirit of entrepreneurship and a talented team of developers, 
        Horizon created “The Easy TMS, Built by Shippers, For Shippers." 
        TMS was created to be a better way to handle shipping, 
        and has since grown to help SMB and Enterprises alike improve their logistics management.
        </p>
      </div>
 </div>
</main>
