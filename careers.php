...
<meta name="theme-color" content="#712cf9">-->
    ...
    <style>
      ...
      .shadow {
        box-shadow: 5px 10px 10px rgba(20, 20, 20, 0.2);
      }
...
<main>
 <div class="container-fluid">
      <div class="row img-bg p-5">
        <div class="container-text text-center">
            <h1 class="h1 p-5 fw-bold">Join our Team!</h1>
            <h4 class="h4 text-outline-success fw-bold pb-5">CHECK BELOW FOR OUR AVAILABLE OPPORTUNITIES</h4>
        </div>
      </div>
      <div class="row col-lg-8 col-sm-10 m-auto py-5">
        <table class="table table-striped">
            <!--fulfill the jobs positions with sql db-->
            <thead>
                <tr>
            ...
            <tbody>
              <?php 
                ...
                $query = "SELECT * FROM ricerca_lavori";
                $result = mysqli_query($connection, $query);
                if (mysqli_num_rows($result)!=0) {
                  while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                    echo "
                    <tr>
                      <td>".$row['posizione_lavorativa']."</td>
                      <td>".$row['luogo_di_lavoro']."</td>
                    </tr>
                    ";
                  }
                };
 ...
 <div class="container my-5 bg-light-subtle rounded shadow">
  <div class="row justify-content-between">
    <div class="col-lg-6 col-sm-8 m-auto">
      <h5 class="h5">Do you think you are the right candidate for one of these positions?
        Contact us and we will be happy to review your profile!
      </h5>
    </div>
    <div class="col-lg-4 col-sm-4 btn-media d-flex align-center">
      <a class="btn btn-success my-3 px-5" href="contacts.php" role="button">
        <h5 class="m-0 py-2 fw-bold">CONTACT US</h5>
      </a>
    </div>
  </div>
 </div>
