    ...
    <div class="container-fluid">
      ...
      <li class="nav-item dropdown mt-1">
		...
		<main class="form-signin w-100 m-auto">
		  <form class="form" action="sign-up-validation.php" method="POST">
			<h1 class="h3 mb-3 fw-medium text-center">Sign Up</h1>
            <div class="form-floating">
			  <input type="text" class="form-control" id="name" name="name" placeholder="ex. Marco Rossi">
			  <label for="name">Nome Utente</label>
			</div>
            <div class="form-floating">
			  <input type="username" class="form-control" id="username" name="username" placeholder="ex. Marco1991">
			  <label for="username">Username</label>
			</div>
			<div class="form-floating">
			  <input type="email" class="form-control" id="email" name="user-email" placeholder="name@example.com">
