...
<div class='container pt-5 mt-5'>
  ...
  <div class='nav-scroller mb-3 border-bottom'>
    <nav class='nav nav-underline justify-content-between'>
      ...
      <a class='nav-item nav-link link-body-emphasis' href='customer-spotlight.php'>Customer Spotlight</a>
      <a class='nav-item nav-link link-body-emphasis active' href='logistics.php'>Logistics</a>
...
$query = "SELECT DISTINCT categories_blog.categories, categories_blog.categories_ID, blog_news.news_title, blog_news.reading_time, blog_news.text_preview FROM categories_blog, blog_news WHERE categories_blog.categories_ID = 'LG'";
