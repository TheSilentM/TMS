...
<!--immagine di copertina-->
  <div class='container-fluid p-0'>
    ...
    <div class='col-lg-6 m-auto text-center p-5'>
      <h1 class='fst-italic'>TMS Case Studies</h1>
      <p class='lead my-3 pt-5'><strong class='mb-2 text-white-emphasis'>See how TMS has helped companies like yours improve Supply Chain Operations and Freight Management.</strong></p>
    </div>
    </div>
  </div>
  <div class='col-lg-12'>
    <div class='col-lg-8 m-auto text-center p-5'>
      <h1 class='fst-italic'>Discover all the Case Studies</h1>
      <p class='lead my-3 pb-5'><strong class='mb-2 text-white-emphasis'>See how TMS has improved the supply chain and logistics operations for companies like yours with these case studies.</strong></p>
  ...
  <div class='col-12'>
    <div class='col-8 m-auto text-center'>
      <h2 class='h2 fw-bold m-0 p-5'>CASE STUDIES</h2>
    </div>
  </div>
<!--All case studies cards-->
    ...
    while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
      echo "
          <div class='col-lg-4 p-3'>
            <div class='card'>
              <img class='card-img-top rounded' src='img/efficiency-withoutbg.png' alt='Card image'>
              <div class='card-body'>
                <h6 class='card-subtitle mb-2 text-success text-center fw-bold'>".$row['category']."</h6>
                <h4 class='card-title pt-2 pb-4 text-center'>".$row['title']."</h4>
                <h6 class='h6 fw-bold'><a class='btn btn-outline-success d-grid w-75 m-auto' href='sea-freight.php'>View details &raquo;</a></h6>
              </div>
            </div>
          </div>
      ";
